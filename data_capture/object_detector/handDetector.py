            ...
            while cap.isOpened():
                ...
                if results.multi_hand_landmarks:
                    ...
                    if (xHandCordMin > padding and yHandCordMin > padding):
                        ...
                        cv2.imwrite(f"/Users/vn53q3k/OneDriveWalmartInc/ml-guitar-tabber/data_capture/captured_frames/currFrame.jpg", handCropped)
                        handImage = model.convertImage(f"/Users/vn53q3k/OneDriveWalmartInc/ml-guitar-tabber/data_capture/captured_frames/currFrame.jpg")
                        chordShape= model.classifyPrediction(model.predict(handImage))
                        print(chordShape)
                        #cv2.putText(image, chordShape,placement = (10, 500),font=cv2.FONT_HERSHEY_SIMPLEX,fontScale=1, fontColor=(255, 255, 255),thickness=1,lineType=2)
